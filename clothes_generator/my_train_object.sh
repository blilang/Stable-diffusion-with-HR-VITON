...
export MODEL_NAME="sd_notextfinetune_clothes_model-Step-12000"
export INSTANCE_DIR="./datasets/test_topwear"
export OUTPUT_DIR="./model_tshirt"
...
accelerate launch tools/train_dreambooth.py \
  ...
  --instance_prompt="a photo of [T]" \
  --with_prior_preservation --prior_loss_weight=1.0 \
  --output_dir=$OUTPUT_DIR \
  --logging_dir=$LOG_DIR \
  --center_crop \
  --class_prompt="a photo of a tshirt" \
